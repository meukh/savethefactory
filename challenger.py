...
def main():
    ...
    # Made it!
    bbox.add_variable(2, "log26", "[%s] Everything has been handled very well. We're back to normal. Congratz! Here's your flag: fl4g{0pc-M4n_c0mIng_tO_The_R3SCue}"%datetime.datetime.now().strftime("%d-%m-%Y %H:%M"))
